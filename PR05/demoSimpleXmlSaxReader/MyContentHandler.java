...
public class MyContentHandler implements ContentHandler {
	...
	public void startDocument() throws SAXException {
		System.out.println("Dokument gestartet ab Zeile " + this.myLocator.getLineNumber());
	}
	...
	public void startPrefixMapping(String prefix, String uri) throws SAXException {
		System.out.println("Namensraum-Beginn: " + prefix + " URI: " + uri);
	}
	...
	public void endElement(String uri, String localName, String qName) throws SAXException {
		System.out.println("Element <" + qName + "> beendet auf Zeile " + this.myLocator.getLineNumber());		
	}
